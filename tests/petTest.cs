...
public class PetTest
{
    ...
    {
        // Configura
        int petId = 3190970;            // campo de pesquisa
        String petName = "Akiles";      // resultado esperado
